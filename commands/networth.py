...
class Networth(Cog):
    ...
    async def networth(self, ctx:discord.ApplicationContext, name: str, profile: str = "selected"):
        await ctx.defer()
        ...
        view = NetworthProfileSelector(ctx.author.id, username, self.bot, parser, cute_name, interaction)
